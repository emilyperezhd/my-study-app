...
;
;
// 1. Setup PDF.js (Legacy build for Node.js)
// @ts-ignore
const pdfjs = (()=>{
    const e = new Error("Cannot find module 'pdfjs-dist/legacy/build/pdf.js'");
...
async function uploadPdf(formData) {
    try {
        ...
        const finalContent = fullText.trim().length > 0 ? fullText : "No text found in PDF.";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12ccba85._.js.map